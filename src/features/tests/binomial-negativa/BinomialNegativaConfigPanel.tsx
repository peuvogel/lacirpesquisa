...
export interface BinomialNegativaLoadedInput {
  headers: string[];
  rows: string[][];
...
export interface BinomialNegativaConfigPanelProps {
  loadedInput: BinomialNegativaLoadedInput;
  alpha: AlphaValue;
...
export function BinomialNegativaConfigPanel({
  loadedInput,
  alpha,
  onAlphaChange,
  researchQuestion,
...
export function BinomialNegativaValidationAlert({ message }: { message: string }) {
  return (
