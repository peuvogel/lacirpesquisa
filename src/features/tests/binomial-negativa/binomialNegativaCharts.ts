...
export function buildBinomialNegativaChartPresets(): ChartPreset<BinomialNegativaEngineOutput>[] {
  return [
    {
      id: 'forest',
...
export function getDefaultBinomialNegativaChartPreset(): string {
  return 'forest';
}

export const binomialNegativaChartPresets = buildBinomialNegativaChartPresets();
