...
export interface PoissonLoadedInput {
  headers: string[];
  rows: string[][];
...
export interface PoissonConfigPanelProps {
  loadedInput: PoissonLoadedInput;
  alpha: AlphaValue;
...
export function PoissonConfigPanel({
  loadedInput,
  alpha,
  onAlphaChange,
  showSoftReset,
...
export function PoissonValidationAlert({ message }: { message: string }) {
  return (
