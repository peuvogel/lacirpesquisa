...
export interface LogisticaLoadedInput {
  headers: string[];
  rows: string[][];
...
export interface LogisticaConfigPanelProps {
  loadedInput: LogisticaLoadedInput;
  alpha: AlphaValue;
...
export function LogisticaConfigPanel({
  loadedInput,
  alpha,
  onAlphaChange,
  researchQuestion,
...
export function LogisticaValidationAlert({ message }: { message: string }) {
  return (
