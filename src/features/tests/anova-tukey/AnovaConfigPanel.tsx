...
export interface AnovaLoadedInput {
  headers: string[];
  rows: string[][];
...
export interface AnovaConfigPanelProps {
  loadedInput: AnovaLoadedInput;
  alpha: AlphaValue;
...
export function AnovaConfigPanel({
  loadedInput,
  alpha,
  onAlphaChange,
  showSoftReset,
...
export function AnovaValidationAlert({ message }: { message: string }) {
  return (
